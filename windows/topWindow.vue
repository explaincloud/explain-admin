  ...
  <view class="header">
    ...
    <view class="navbar" :class="{'navbar-mini':!matchLeftWindow,'popup-menu':popupMenuOpened}">
      <view class="navbar-left">
        <view class="logo">
          <navigator class="navigator pointer" open-type="reLaunch" url="/">
            <image src="/static/admin.png" mode="heightFix"></image>
            <text>explain-admin</text>
          </navigator>
        </view>
        <uni-icons @click="toggleSidebar" :type="menuIcon" class="menu-icon" size="30" color="#999"></uni-icons>
      </view>
      ...
      <view class="navbar-right">
        <view @click="togglePopupMenu" class="navbar-user">
          <view class="username"><text>{{userInfo.nickname}}</text>️</view>
        ...
        <view class="navbar-menu">
          ...
          <template>
            <view class="menu-item username">
              <uni-icons class="person" type="person" color="#666" size="14"></uni-icons>
              <text>{{userInfo.nickname}}</text>
            </view>
            <view class="menu-item">
              <text class="logout pointer" @click="toPersonal">个人中心</text>
            </view>
            <view class="menu-item ">
              <text class="logout pointer" @click="onLogout">退出</text>
            </view>
          </template>
